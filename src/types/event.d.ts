...
type SubscribeHandler = (msg: { call: "subscribe"; events: string[] }) => void;
...
type CactbotSayHandler = (msg: { call: "cactbotSay"; text: string }) => void;
...
export type OverlayHandlerAnyRequest =
  OverlayHandlerRequests[OverlayHandlerTypes];
...
export type OverlayHandlerAnyResponse =
  OverlayHandlerResponses[OverlayHandlerTypes];
...
type UnionToIntersection<U> = (U extends U ? (k: U) => void : never) extends (
  ...
  ? I
  : never;
export type IOverlayHandler = UnionToIntersection<
  OverlayHandlerFuncs[OverlayHandlerTypes]
>;
